...
public class FragmentedStorageBackendAdaptor extends StorageBackend {
  ...
  private int getSegmentId(long key) {
    return (int)
        (RandomSupport.mixStafford13(RandomSupport.mixStafford13(key) ^ key)
  ...
  public void putIdMapping(int id, ByteBuffer data) {
    // Replicate the mappings over all the dbs to mean the chance of recovery in case of corruption
    // is 30x
    for (var backend : this.backends) {
  ...
  public Int2ObjectOpenHashMap<byte[]> getIdMappingsData() {
    Object2IntOpenHashMap<Int2ObjectOpenHashMap<EqualingArray>> verification =
