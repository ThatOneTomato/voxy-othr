 ...
 * same-FQN dual implementation provided by each loader source set (src/fabric, src/neoforge),
 * so this class can instantiate it directly without depending on any loader API.
 */
