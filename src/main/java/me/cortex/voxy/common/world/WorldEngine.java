...
public class WorldEngine {
  ...
  public static final int DEFAULT_UPDATE_FLAGS =
      UPDATE_TYPE_BLOCK_BIT | UPDATE_TYPE_CHILD_EXISTENCE_BIT;
  ...
  public interface ISectionSaveCallback {
    boolean save(
        ...
        boolean nonBlocking,
        boolean sectionAlreadyAcquired);
  }
  ...
  volatile long lastActiveTime =
      System.currentTimeMillis(); // Time in millis the world was last "active" i.e. had a total ref

  // count or active section count of != 0
  ...
  // TODO: Fixme/optimize, cause as the lvl gets higher, the size of x,y,z gets smaller so i can
  // dynamically compact the format
  ...
  public void addDebugData(List<String> debug) {
    debug.add(
        "ACC/SCC: "
            ...
            + "/"
            + this.sectionTracker
                .getSecondaryCacheSize()); // Active cache count, Secondary cache counts
  }
  ...
  private static final long TIMEOUT_MILLIS =
      10_000; // 10 second timeout (is to long? or to short??)
