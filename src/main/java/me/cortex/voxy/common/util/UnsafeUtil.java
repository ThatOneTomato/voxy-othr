...
public class UnsafeUtil {
  ...
  // Copy the entire length of src to the dst memory where dst is a byte array (source length from
  // dst)
  ...
  // Copy the entire length of src to the dst memory where src is a byte array (source length from
  // src)
