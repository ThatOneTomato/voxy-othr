...
public abstract class VoxyConfigScreenPages {
  ...
  public static OptionPage page() {
                ...
                OptionImpl.createBuilder(boolean.class, storage)
                    ...
                    .setBinding(
                        (s, v) -> {
                          ...
                          if (!v) {
                            var vrsh =
                                (VoxyRenderSystemAccess) Minecraft.getInstance().levelRenderer;
                            if (vrsh != null) {
        ...
        OptionGroup.createBuilder()
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setTooltip(
                        Component.translatable("voxy.config.general.serviceThreads.tooltip"))
                    .setControl(
                        opt ->
                            new SliderControl(
                                opt,
            ...
            .add(
                OptionImpl.createBuilder(boolean.class, storage)
                    ...
                    .setTooltip(
                        Component.translatable("voxy.config.general.useSodiumBuilder.tooltip"))
                    .setControl(TickBoxControl::new)
        ...
        OptionGroup.createBuilder()
            ...
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setTooltip(
                        Component.translatable("voxy.config.general.subDivisionSize.tooltip"))
                    .setControl(
                        opt ->
                            new SliderControl(
                                opt,
                    ...
                    .setBinding(
                        (s, v) -> s.subDivisionSize = ln2subDiv(v),
                        s -> subDiv2ln(s.subDivisionSize))
                    .setImpact(OptionImpact.HIGH)
                    .build())
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setTooltip(
                        Component.translatable("voxy.config.general.renderDistance.tooltip"))
    ...
    OptionImpl<VoxyConfig, Boolean> adaptCloudDistanceOption =
        OptionImpl.createBuilder(boolean.class, storage)
            .setName(Component.literal("Adapt cloud distance"))
            .setTooltip(
                Component.literal(
                    "Extends the cloud distance according to the current render distance. It's automatically capped at 256"))
            .setControl(TickBoxControl::new)
        ...
        OptionGroup.createBuilder()
            ...
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setControl(
                        opt ->
                            new SliderControl(
                                opt, 16, 512, 16, v -> Component.literal(Integer.toString(v))))
            ...
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setTooltip(
                        Component.literal(
                            "Multiplier for terrain fog opacity. 0.0 = off, 1.0 = vanilla, 3.0 = triple"))
                    .setControl(
                        opt ->
                            new SliderControl(
                                opt,
                                ...
                                300,
                                10,
                                v -> Component.literal(String.format("%.1f", v / 100.0f))))
                    .setBinding(
                        (s, v) -> s.fogIntensity = v / 100.0f, s -> (int) (s.fogIntensity * 100))
                    .build())
            .add(
                OptionImpl.createBuilder(int.class, storage)
                    ...
                    .setTooltip(
                        Component.literal(
                            "Shape of the fog curve. 0.0 = linear, higher values push fog towards the far end"))
                    .setControl(
                        opt ->
                            new SliderControl(
                                opt,
                                ...
                                50,
                                1,
                                v -> Component.literal(String.format("%.1f", v / 10.0f))))
            ...
            .add(
                OptionImpl.createBuilder(SSAO.SSAOMode.class, storage)
                    ...
                    .setControl(
                        opt -> new CyclingControl<>(opt, SSAO.SSAOMode.class, SSAO_MODE_LABELS))
                    .setBinding(
                        (s, v) -> {
                          s.setSSAOMode(v);
  ...
  private static int subDiv2ln(float in) {
    return (int)
        (((Math.log(((double) in) / SUBDIV_MIN) / Math.log(2)) / SUBDIV_CONST) * SUBDIV_IN_MAX);
  }
}
