...
/** Client-side view of the simulated contraption render distance used by the Sable compat. */
public final class SableClientRenderDistance {
  ...
  public static double getRenderDistanceBlocks(int vanillaRenderDistanceChunks) {
    return extendVanillaRenderDistanceChunks(vanillaRenderDistanceChunks)
        * (double) BLOCKS_PER_CHUNK;
  }
