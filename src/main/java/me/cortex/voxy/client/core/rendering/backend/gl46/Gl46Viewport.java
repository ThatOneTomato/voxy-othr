...
/**
 * GL46-side viewport state: the HiZ occlusion pyramid and the traversal render list are consumed
 * exclusively by the gl46 traversal/pipeline machinery, so they live here rather than on the shared
 * {@link Viewport}.
 */
