...
// TODO: need to add neighboring chunk data aswell? or somehow do a linking thing where this is
// stored in a secondary storage
//  where we can link them together (or store the neighbor faces seperately or something) might be
