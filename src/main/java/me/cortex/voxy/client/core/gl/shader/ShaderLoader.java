...
public class ShaderLoader {
  public static String parse(String id) {
    return parse(id, "460 core");
  }

  public static String parse(String id, String glslVersion) {
    var src = "#version " + glslVersion + "\n";
    ...
    public static List<String> parseRoot(ResourceLocation id) {
      ...
      for (var line : toLines(loadShaderAsset(id))) {
        if (line.startsWith("#version")) {
          ...
          var iid =
              ResourceLocation.fromNamespaceAndPath(match.group("namespace"), match.group("path"));
