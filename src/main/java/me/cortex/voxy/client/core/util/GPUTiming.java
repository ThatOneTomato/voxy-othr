 ...
 * facade at its stage boundaries, so retaining a no-op implementation keeps the render path free of
 * query creation, driver calls, polling, and result allocation.
 */
