...
/**
 * Persistent index of Sable "holding chunks" (chunks whose data holds serialized sub levels), so
 * the LOD chunk manager can find and load distant contraptions after a world reload.
 */
public final class SableHoldingChunkIndexSavedData extends SavedData {
  ...
  private static SableHoldingChunkIndexSavedData load(
    ...
    return level
        ...
        .computeIfAbsent(
            new SavedData.Factory<>(
                SableHoldingChunkIndexSavedData::new,
                SableHoldingChunkIndexSavedData::load,
                DataFixTypes.LEVEL),
            FILE_ID);
  }
